(function () {
  ...
  const dict = {
    en: {
      ...
      journalIntro: "Read practical guidance on how to wear, care for, and choose cashmere pieces that stay useful season after season.",
      ...
      relatedPostsNote: "Continue with care, styling, and wardrobe notes.",
      listingBriefNote: "Customer-ready product notes covering feel, fit, care, colors, and intended occasions.",
